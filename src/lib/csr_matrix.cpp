...
void ThreeDimensionalDiffusion::calc_adjacent_nodes()
{
  int tmp;
  bool b1;
...
void ThreeDimensionalDiffusion::calc_adjacent_elements()
{
  int tmp;
...
void ThreeDimensionalDiffusion::CSR_initialize(const vector<vector<int>> &inb,const int &numOfNode,const int &dim)
{
...
void ThreeDimensionalDiffusion::CSR_ptr_initialize(const vector<vector<int>> &inb,const int &numOfNode,const int &dim)
{
  nnz = 0;
  for(int i=0;i<dim;i++){
    for(int ic=0;ic<numOfNode;ic++){
...
void ThreeDimensionalDiffusion::CSR_index_initialize(const vector<vector<int>> &inb,const int &numOfNode,const int &dim)
{
  int tmp = 0;
...
void ThreeDimensionalDiffusion::set_CSR_value1D(vector<ARRAY2D<double>> &K,const vector<vector<int>> &element,const int &numOfNode,
