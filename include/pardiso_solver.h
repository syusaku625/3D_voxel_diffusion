...
class PARDISO_solver{
 public:
  ...
  void set_CSR_value1D(std::vector<ARRAY2D<double>> &K, const std::vector<std::vector<int>> &element,const int &numOfNode,const int &numOfElm,const std::vector<std::vector<int>> &inb);
